...
3. Gelen aramalar SIP trunk ile `sip.vapi.ai` adresine yönlendirilir. Panelde bu seçenek
   yoksa Netgsm destekten istenir.
...
2. **Phone Numbers → Import → BYO SIP Trunk Number**:
   - Numara başında 0 olmadan yazılır (`850xxxxxxx`), 1. adımdaki kimlik bilgisi seçilir.
