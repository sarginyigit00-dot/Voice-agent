...
export const appConfig: AppConfig = {
  ...
  marketing: {
    ...
    pricing: [
      { name: "Muayenehane", price: "$199", period: "/mo", tagline: { tr: "1–2 hekimli muayenehaneler için. Sekreterinizi değiştirmez, kaçırdıklarını yakalar.", en: "For 1–2 dentist practices. Keeps your receptionist, catches what they miss." }, features: [{ tr: "Ayda 500 dakika", en: "500 minutes / month" }, { tr: "7/24 telefon karşılama: tüm hat ya da sadece meşgul / mesai dışı", en: "24/7 answering: the whole line, or only when busy / after hours" }, { tr: "Takvime gerçek randevu", en: "Real bookings into your calendar" }, { tr: "Ses kaydı, transkript ve özet", en: "Recording, transcript and summary" }, { tr: "Randevusuz aramada kliniğe e-posta", en: "Email to the clinic when a call ends without a booking" }, { tr: "Aşım: dakikası 0,30 $", en: "Overage: $0.30 / minute" }], cta: { tr: "Demo talep et", en: "Request a demo" } },
      { name: "Klinik", price: "$399", period: "/mo", tagline: { tr: "3–5 hekimli klinikler için. Telefonu baştan sona ajan yönetir.", en: "For 3–5 dentist clinics. The agent runs the whole phone line." }, features: [{ tr: "Ayda 1.500 dakika", en: "1,500 minutes / month" }, { tr: "Muayenehane paketindeki her şey", en: "Everything in Muayenehane" }, { tr: "SMS hatırlatma: randevudan 24 ve 2 saat önce", en: "SMS reminders 24 h and 2 h before each appointment" }, { tr: "İptal ve erteleme bildirimi", en: "Cancellation and reschedule notices" }, { tr: "Dahili CRM", en: "Built-in CRM" }, { tr: "Aşım: dakikası 0,30 $", en: "Overage: $0.30 / minute" }], cta: { tr: "Demo talep et", en: "Request a demo" }, featured: true },
      { name: "Poliklinik", price: "$799", period: "/mo", tagline: { tr: "6+ hekimli poliklinik, ADSM ve çok şubeli klinikler için.", en: "For polyclinics and multi-branch clinics with 6+ dentists." }, features: [{ tr: "Ayda 3.000 dakika", en: "3,000 minutes / month" }, { tr: "Klinik paketindeki her şey", en: "Everything in Klinik" }, { tr: "Hızlı geri dönüş: formu dolduran hasta anında aranır", en: "Speed-to-lead: anyone who fills your form is called right away" }, { tr: "Şube ya da hat başına ayrı ajan", en: "A separate agent per branch or line" }, { tr: "Aylık optimizasyon görüşmesi", en: "Monthly optimisation call" }, { tr: "Öncelikli destek", en: "Priority support" }, { tr: "Aşım: dakikası 0,30 $", en: "Overage: $0.30 / minute" }], cta: { tr: "Demo talep et", en: "Request a demo" } },
    ],
    faq: [
