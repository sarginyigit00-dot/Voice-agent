...
export const appConfig: AppConfig = {
  ...
  marketing: {
    ...
    pricing: [
      { name: "Klinik", price: "$500", period: "/mo", tagline: { tr: "Tek hatlı klinikler için anahtar teslim.", en: "Turnkey, for single-line clinics." }, features: [{ tr: "1 telefon hattı", en: "1 phone line" }, { tr: "Ayda 1.000 dakika", en: "1,000 minutes / month" }, { tr: "Türkçe + İngilizce", en: "Turkish + English" }, { tr: "Takvime randevu", en: "Calendar booking" }, { tr: "SMS / WhatsApp onay ve hatırlatma", en: "SMS / WhatsApp confirmations & reminders" }, { tr: "Aşım: dakikası 0,30 $", en: "Overage: $0.30 / minute" }], cta: { tr: "Demo talep et", en: "Request a demo" } },
      { name: "Klinik Pro", price: "$1,000", period: "/mo", tagline: { tr: "Yoğun ve çok dilli klinikler için.", en: "For busy, multilingual clinics." }, features: [{ tr: "Klinik paketindeki her şey", en: "Everything in Klinik" }, { tr: "Ayda 2.500 dakika", en: "2,500 minutes / month" }, { tr: "Birden fazla ajan ve dil", en: "Multiple agents and languages" }, { tr: "CRM entegrasyonu", en: "CRM integration" }, { tr: "Öncelikli destek", en: "Priority support" }, { tr: "Aşım: dakikası 0,30 $", en: "Overage: $0.30 / minute" }], cta: { tr: "Demo talep et", en: "Request a demo" }, featured: true },
    ],
    faq: [
